...
QEMUOPTS = -drive file=fs.img,index=1,media=disk,format=raw -drive file=xv6.img,index=0,media=disk,format=raw -smp $(CPUS) -nographic -m 512 $(QEMUEXTRA) $(KVMOPTS)
...
EXTRA=\
	...
	ln.c ls.c mkdir.c rm.c stressfs.c workload.S usertests.c wc.c zombie.c\
	printf.c umalloc.c\
